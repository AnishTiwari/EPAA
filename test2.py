...
fig.suptitle('COGNITIVE LEVEL(Internal Test 2)')
fig.savefig(newpath + "/Test2_CL.pdf")


new = pd.DataFrame({'COs':y})
new = new.plot.bar()
fig9 = new.get_figure()
fig9.suptitle('COURSE OUTCOMES (Internal Test 2)')
fig9.savefig(newpath+"/Test2_CO.pdf")
...
co_df.to_csv(newpath + "/co_pass2.csv")
cl_df.to_csv(newpath + "/cl_pass2.csv")
...
vdf = vdf.plot.bar()
fig = vdf.get_figure()
fig.suptitle('OVERALL PERFORMANCE (Internal Test 2)')
fig.savefig(newpath+"/Overall_Performance_test2.pdf")


cos_max_csv2 = pd.DataFrame(cos_max.items())
cos_max_csv2.to_csv(newpath+"\max_co2.csv")
